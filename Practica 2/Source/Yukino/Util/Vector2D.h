...
//******************************************************************************************
#ifndef _YUKINO_UTIL_VECTOR2D_H_
#define _YUKINO_UTIL_VECTOR2D_H_
//******************************************************************************************
// Includes
//******************************************************************************************
#include "../Base.h"
...
namespace Yukino
{
	...
	public:
		...
		Vector2D Subtract      (const Vector2D & obj) const;
		Vector2D ScalarProduct (GLfloat s) const;
		GLfloat  DotProduct    (const Vector2D & obj) const;
		Vector2D CrossProduct  (const Vector2D & obj) const;

		GLfloat GetAngle (const Vector2D & obj) const;
